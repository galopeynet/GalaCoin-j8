...
public enum ApiSpec {
    ...
    getBlocks(null, "firstIndex", "lastIndex", "timestamp", "includeTransactions", "includeExecutedPhased", "adminPassword", "requireBlock", "requireLastBlock"),

    getAssetsByIssuer(null, "account", "account", "account", "firstIndex", "lastIndex", "includeCounts", "adminPassword", "requireBlock", "requireLastBlock"),

    getExchangesByOffer(null, "offer", "includeCurrencyInfo", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getAllOpenBidOrders(null, "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getDataTagsLike(null, "tagPrefix", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getFundingMonitor(null, "holdingType", "holding", "property", "secretPhrase", "includeMonitoredAccounts", "account", "adminPassword"),

    getPolls(null, "account", "firstIndex", "lastIndex", "timestamp", "includeFinished", "finishedOnly", "adminPassword", "requireBlock", "requireLastBlock"),

    downloadTaggedData(null, "transaction", "retrieve", "requireBlock", "requireLastBlock"),

    getDataTags(null, "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getPollVote(null, "poll", "account", "includeWeights", "requireBlock", "requireLastBlock"),

    getAssetDeletes(null, "asset", "account", "firstIndex", "lastIndex", "timestamp", "includeAssetInfo", "adminPassword", "requireBlock", "requireLastBlock"),

    addPeer(null, "peer", "adminPassword"),

    getSharedKey(null, "account", "secretPhrase", "nonce"),

    decodeToken(null, "website", "token"),

    popOff(null, "numBlocks", "height", "keepTransactions", "adminPassword"),

    getAccountPhasedTransactions(null, "account", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getAssetAccounts(null, "asset", "height", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getCurrencyFounders(null, "currency", "account", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    currencyBuy(null, "currency", "rateNQT", "units", "secretPhrase", "publicKey", "feeNQT", "deadline", "referencedTransactionFullHash", "broadcast", "message", "messageIsText", "messageIsPrunable", "messageToEncrypt", "messageToEncryptIsText", "encryptedMessageData", "encryptedMessageNonce", "encryptedMessageIsPrunable", "compressMessageToEncrypt", "messageToEncryptToSelf", "messageToEncryptToSelfIsText", "encryptToSelfMessageData", "encryptToSelfMessageNonce", "compressMessageToEncryptToSelf", "phased", "phasingFinishHeight", "phasingVotingModel", "phasingQuorum", "phasingMinBalance", "phasingHolding", "phasingMinBalanceModel", "phasingWhitelisted", "phasingWhitelisted", "phasingWhitelisted", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingHashedSecret", "phasingHashedSecretAlgorithm", "recipientPublicKey", "ecBlockId", "ecBlockHeight"),

    decodeQRCode(null, "qrCodeBase64"),

    getAllExchanges(null, "timestamp", "firstIndex", "lastIndex", "includeCurrencyInfo", "adminPassword", "requireBlock", "requireLastBlock"),

    getCurrencyTransfers(null, "currency", "account", "firstIndex", "lastIndex", "timestamp", "includeCurrencyInfo", "adminPassword", "requireBlock", "requireLastBlock"),

    getExpectedOrderCancellations(null, "requireBlock", "requireLastBlock"),

    eventRegister(null, "event", "event", "event", "add", "remove"),

    scan(null, "numBlocks", "height", "validate", "adminPassword"),
    ...
    getChannelTaggedData(null, "channel", "account", "firstIndex", "lastIndex", "includeData", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getAssetProperties(null, "asset", "setter", "property", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    blacklistAPIProxyPeer(null, "peer", "adminPassword"),

    getPeer(null, "peer"),

    getAccountCurrentAskOrderIds(null, "account", "asset", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getUnconfirmedTransactionIds(null, "account", "account", "account", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getAccountShufflings(null, "account", "includeFinished", "includeHoldingInfo", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getAliasesLike(null, "aliasPrefix", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getAllBroadcastedTransactions(null, "adminPassword", "requireBlock", "requireLastBlock"),

    placeBidOrder(null, "asset", "quantityQNT", "priceNQT", "secretPhrase", "publicKey", "feeNQT", "deadline", "referencedTransactionFullHash", "broadcast", "message", "messageIsText", "messageIsPrunable", "messageToEncrypt", "messageToEncryptIsText", "encryptedMessageData", "encryptedMessageNonce", "encryptedMessageIsPrunable", "compressMessageToEncrypt", "messageToEncryptToSelf", "messageToEncryptToSelfIsText", "encryptToSelfMessageData", "encryptToSelfMessageNonce", "compressMessageToEncryptToSelf", "phased", "phasingFinishHeight", "phasingVotingModel", "phasingQuorum", "phasingMinBalance", "phasingHolding", "phasingMinBalanceModel", "phasingWhitelisted", "phasingWhitelisted", "phasingWhitelisted", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingHashedSecret", "phasingHashedSecretAlgorithm", "recipientPublicKey", "ecBlockId", "ecBlockHeight"),

    getAccountBlocks(null, "account", "timestamp", "firstIndex", "lastIndex", "includeTransactions", "adminPassword", "requireBlock", "requireLastBlock"),

    getShuffling(null, "shuffling", "includeHoldingInfo", "requireBlock", "requireLastBlock"),

    setAPIProxyPeer(null, "peer", "adminPassword"),
    ...
    getAccountCurrentBidOrderIds(null, "account", "asset", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getAllPhasingOnlyControls(null, "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    dgsRefund(null, "purchase", "refundNQT", "secretPhrase", "publicKey", "feeNQT", "deadline", "referencedTransactionFullHash", "broadcast", "message", "messageIsText", "messageIsPrunable", "messageToEncrypt", "messageToEncryptIsText", "encryptedMessageData", "encryptedMessageNonce", "encryptedMessageIsPrunable", "compressMessageToEncrypt", "messageToEncryptToSelf", "messageToEncryptToSelfIsText", "encryptToSelfMessageData", "encryptToSelfMessageNonce", "compressMessageToEncryptToSelf", "phased", "phasingFinishHeight", "phasingVotingModel", "phasingQuorum", "phasingMinBalance", "phasingHolding", "phasingMinBalanceModel", "phasingWhitelisted", "phasingWhitelisted", "phasingWhitelisted", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingHashedSecret", "phasingHashedSecretAlgorithm", "recipientPublicKey", "ecBlockId", "ecBlockHeight"),

    getAssetIds(null, "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getTaggedData(null, "transaction", "includeData", "retrieve", "requireBlock", "requireLastBlock"),

    searchAccounts(null, "query", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getAccountLedger(null, "account", "firstIndex", "lastIndex", "eventType", "event", "holdingType", "holding", "includeTransactions", "includeHoldingInfo", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getBlockchainTransactions(null, "account", "timestamp", "type", "subtype", "firstIndex", "lastIndex", "numberOfConfirmations", "withMessage", "phasedOnly", "nonPhasedOnly", "includeExpiredPrunable", "includePhasingResult", "executedOnly", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getAccountTaggedData(null, "account", "firstIndex", "lastIndex", "includeData", "adminPassword", "requireBlock", "requireLastBlock"),

    getAllTrades(null, "timestamp", "firstIndex", "lastIndex", "includeAssetInfo", "adminPassword", "requireBlock", "requireLastBlock"),

    getStackTraces(null, "depth", "adminPassword"),

    rsConvert(null, "account"),

    searchTaggedData(null, "query", "tag", "channel", "account", "firstIndex", "lastIndex", "includeData", "adminPassword", "requireBlock", "requireLastBlock"),

    getAllTaggedData(null, "firstIndex", "lastIndex", "includeData", "adminPassword", "requireBlock", "requireLastBlock"),

    getDGSPendingPurchases(null, "seller", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getECBlock(null, "timestamp", "requireBlock", "requireLastBlock"),

    generateFileToken("file", "secretPhrase"),

    searchDGSGoods(null, "query", "tag", "seller", "firstIndex", "lastIndex", "inStockOnly", "hideDelisted", "includeCounts", "adminPassword", "requireBlock", "requireLastBlock"),

    getAccountPhasedTransactionCount(null, "account", "requireBlock", "requireLastBlock"),

    getCurrencyAccounts(null, "currency", "height", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    managePeersNetworking(null, "operation", "adminPassword"),
    ...
    searchPolls(null, "query", "firstIndex", "lastIndex", "includeFinished", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getBidOrderIds(null, "asset", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    blacklistPeer(null, "peer", "adminPassword"),
    ...
    sendTransaction(null, "transactionJSON", "transactionBytes", "prunableAttachmentJSON", "adminPassword"),

    getAssignedShufflings(null, "account", "includeHoldingInfo", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getAskOrders(null, "asset", "firstIndex", "lastIndex", "showExpectedCancellations", "adminPassword", "requireBlock", "requireLastBlock"),

    stopForging(null, "secretPhrase", "adminPassword"),

    getAccountExchangeRequests(null, "account", "currency", "includeCurrencyInfo", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    clearUnconfirmedTransactions(null, "adminPassword"),

    getHoldingShufflings(null, "holding", "stage", "includeFinished", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getAssetDividends(null, "asset", "firstIndex", "lastIndex", "timestamp", "includeHoldingInfo", "adminPassword", "requireBlock", "requireLastBlock"),

    getAssetPhasedTransactions(null, "asset", "account", "withoutWhitelist", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getAccountCurrentBidOrders(null, "account", "asset", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    searchAssets(null, "query", "firstIndex", "lastIndex", "includeCounts", "adminPassword", "requireBlock", "requireLastBlock"),

    getDataTagCount(null, "requireBlock", "requireLastBlock"),

    bootstrapAPIProxy(null, "adminPassword"),

    dgsDelisting(null, "goods", "secretPhrase", "publicKey", "feeNQT", "deadline", "referencedTransactionFullHash", "broadcast", "message", "messageIsText", "messageIsPrunable", "messageToEncrypt", "messageToEncryptIsText", "encryptedMessageData", "encryptedMessageNonce", "encryptedMessageIsPrunable", "compressMessageToEncrypt", "messageToEncryptToSelf", "messageToEncryptToSelfIsText", "encryptToSelfMessageData", "encryptToSelfMessageNonce", "compressMessageToEncryptToSelf", "phased", "phasingFinishHeight", "phasingVotingModel", "phasingQuorum", "phasingMinBalance", "phasingHolding", "phasingMinBalanceModel", "phasingWhitelisted", "phasingWhitelisted", "phasingWhitelisted", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingHashedSecret", "phasingHashedSecretAlgorithm", "recipientPublicKey", "ecBlockId", "ecBlockHeight"),

    deleteCurrency(null, "currency", "secretPhrase", "publicKey", "feeNQT", "deadline", "referencedTransactionFullHash", "broadcast", "message", "messageIsText", "messageIsPrunable", "messageToEncrypt", "messageToEncryptIsText", "encryptedMessageData", "encryptedMessageNonce", "encryptedMessageIsPrunable", "compressMessageToEncrypt", "messageToEncryptToSelf", "messageToEncryptToSelfIsText", "encryptToSelfMessageData", "encryptToSelfMessageNonce", "compressMessageToEncryptToSelf", "phased", "phasingFinishHeight", "phasingVotingModel", "phasingQuorum", "phasingMinBalance", "phasingHolding", "phasingMinBalanceModel", "phasingWhitelisted", "phasingWhitelisted", "phasingWhitelisted", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingHashedSecret", "phasingHashedSecretAlgorithm", "recipientPublicKey", "ecBlockId", "ecBlockHeight"),

    getAssetTransfers(null, "asset", "account", "firstIndex", "lastIndex", "timestamp", "includeAssetInfo", "adminPassword", "requireBlock", "requireLastBlock"),

    getBalance(null, "account", "includeEffectiveBalance", "height", "requireBlock", "requireLastBlock"),

    getCurrencyPhasedTransactions(null, "currency", "account", "withoutWhitelist", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getDGSGoods(null, "seller", "firstIndex", "lastIndex", "inStockOnly", "hideDelisted", "includeCounts", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    setLogging(null, "logLevel", "communicationEvent", "communicationEvent", "communicationEvent", "adminPassword"),
    ...
    getAllAssets(null, "firstIndex", "lastIndex", "includeCounts", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getReferencingTransactions(null, "transaction", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    luceneReindex(null, "adminPassword"),

    deleteAssetProperty(null, "asset", "property", "setter", "secretPhrase", "publicKey", "feeNQT", "deadline", "referencedTransactionFullHash", "broadcast", "message", "messageIsText", "messageIsPrunable", "messageToEncrypt", "messageToEncryptIsText", "encryptedMessageData", "encryptedMessageNonce", "encryptedMessageIsPrunable", "compressMessageToEncrypt", "messageToEncryptToSelf", "messageToEncryptToSelfIsText", "encryptToSelfMessageData", "encryptToSelfMessageNonce", "compressMessageToEncryptToSelf", "phased", "phasingFinishHeight", "phasingVotingModel", "phasingQuorum", "phasingMinBalance", "phasingHolding", "phasingMinBalanceModel", "phasingWhitelisted", "phasingWhitelisted", "phasingWhitelisted", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingHashedSecret", "phasingHashedSecretAlgorithm", "recipientPublicKey", "ecBlockId", "ecBlockHeight"),

    fullReset(null, "adminPassword"),

    getAccountBlockIds(null, "account", "timestamp", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getCurrenciesByIssuer(null, "account", "account", "account", "firstIndex", "lastIndex", "includeCounts", "adminPassword", "requireBlock", "requireLastBlock"),

    getPeers(null, "active", "state", "service", "service", "service", "includePeerInfo"),

    getAllShufflings(null, "includeFinished", "includeHoldingInfo", "finishedOnly", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    placeAskOrder(null, "asset", "quantityQNT", "priceNQT", "secretPhrase", "publicKey", "feeNQT", "deadline", "referencedTransactionFullHash", "broadcast", "message", "messageIsText", "messageIsPrunable", "messageToEncrypt", "messageToEncryptIsText", "encryptedMessageData", "encryptedMessageNonce", "encryptedMessageIsPrunable", "compressMessageToEncrypt", "messageToEncryptToSelf", "messageToEncryptToSelfIsText", "encryptToSelfMessageData", "encryptToSelfMessageNonce", "compressMessageToEncryptToSelf", "phased", "phasingFinishHeight", "phasingVotingModel", "phasingQuorum", "phasingMinBalance", "phasingHolding", "phasingMinBalanceModel", "phasingWhitelisted", "phasingWhitelisted", "phasingWhitelisted", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingHashedSecret", "phasingHashedSecretAlgorithm", "recipientPublicKey", "ecBlockId", "ecBlockHeight"),

    rebroadcastUnconfirmedTransactions(null, "adminPassword"),

    getAllCurrencies(null, "firstIndex", "lastIndex", "includeCounts", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getAskOrderIds(null, "asset", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getCurrencyIds(null, "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    shufflingProcess(null, "shuffling", "recipientSecretPhrase", "recipientPublicKey", "secretPhrase", "publicKey", "feeNQT", "deadline", "referencedTransactionFullHash", "broadcast", "message", "messageIsText", "messageIsPrunable", "messageToEncrypt", "messageToEncryptIsText", "encryptedMessageData", "encryptedMessageNonce", "encryptedMessageIsPrunable", "compressMessageToEncrypt", "messageToEncryptToSelf", "messageToEncryptToSelfIsText", "encryptToSelfMessageData", "encryptToSelfMessageNonce", "compressMessageToEncryptToSelf", "phased", "phasingFinishHeight", "phasingVotingModel", "phasingQuorum", "phasingMinBalance", "phasingHolding", "phasingMinBalanceModel", "phasingWhitelisted", "phasingWhitelisted", "phasingWhitelisted", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingLinkedFullHash", "phasingHashedSecret", "phasingHashedSecretAlgorithm", "recipientPublicKey", "ecBlockId", "ecBlockHeight"),

    requeueUnconfirmedTransactions(null, "adminPassword"),
    ...
    getAliases(null, "timestamp", "account", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    trimDerivedTables(null, "adminPassword"),

    getSellOffers(null, "currency", "account", "availableOnly", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getLog(null, "count", "adminPassword"),

    getAssetHistory(null, "asset", "account", "firstIndex", "lastIndex", "timestamp", "includeAssetInfo", "deletesOnly", "increasesOnly", "adminPassword", "requireBlock", "requireLastBlock"),

    deleteScheduledTransaction(null, "transaction", "adminPassword"),
    ...
    getDGSTagsLike(null, "tagPrefix", "inStockOnly", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getBidOrders(null, "asset", "firstIndex", "lastIndex", "showExpectedCancellations", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getDGSPurchases(null, "seller", "buyer", "firstIndex", "lastIndex", "withPublicFeedbacksOnly", "completed", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getScheduledTransactions(null, "account", "adminPassword"),
    ...
    getVoterPhasedTransactions(null, "account", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    shutdown(null, "scan", "adminPassword"),

    getDGSExpiredPurchases(null, "seller", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    searchCurrencies(null, "query", "firstIndex", "lastIndex", "includeCounts", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getPollVotes(null, "poll", "firstIndex", "lastIndex", "includeWeights", "adminPassword", "requireBlock", "requireLastBlock"),

    getAccountCurrentAskOrders(null, "account", "asset", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getDGSTags(null, "inStockOnly", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getOrderTrades(null, "askOrder", "bidOrder", "includeAssetInfo", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getAllOpenAskOrders(null, "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getAllPrunableMessages(null, "firstIndex", "lastIndex", "timestamp", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getDGSGoodsPurchases(null, "goods", "buyer", "firstIndex", "lastIndex", "withPublicFeedbacksOnly", "completed", "adminPassword", "requireBlock", "requireLastBlock"),

    getAssetAccountCount(null, "asset", "height", "requireBlock", "requireLastBlock"),

    getPhasingPollVotes(null, "transaction", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    retrievePrunedData(null, "adminPassword"),

    getUnconfirmedTransactions(null, "account", "account", "account", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    encryptTo(null, "recipient", "messageToEncrypt", "messageToEncryptIsText", "compressMessageToEncrypt", "secretPhrase"),

    getBuyOffers(null, "currency", "account", "availableOnly", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getTrades(null, "asset", "account", "firstIndex", "lastIndex", "timestamp", "includeAssetInfo", "adminPassword", "requireBlock", "requireLastBlock"),

    getPrunableMessages(null, "account", "otherAccount", "secretPhrase", "firstIndex", "lastIndex", "timestamp", "adminPassword", "requireBlock", "requireLastBlock"),
    ...
    getAccountProperties(null, "recipient", "property", "setter", "firstIndex", "lastIndex", "adminPassword", "requireBlock", "requireLastBlock"),

    getExchanges(null, "currency", "account", "firstIndex", "lastIndex", "timestamp", "includeCurrencyInfo", "adminPassword", "requireBlock", "requireLastBlock");
